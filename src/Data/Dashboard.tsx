...
import { Box, MessageSquare, Navigation, Users, ShoppingBag, Package, List, CheckSquare, DollarSign, User, Star } from "react-feather";
...
export const  TopDashboardCardsData = [
  {
    ...
    icon: <FaRupeeSign className="font-secondary" />,
  },
  {
    id: 2,
    ...
    icon: <Box className="font-warning" />,
  },
  {
    id: 3,
    type: "Total Orders",
    ...
    count: 600, 
    label: "Total Orders",
    icon: <Package className="font-secondary" />,
  },
  {
    id: 4,
    type: "Pending Orders",
    ...
    icon: <List className="font-secondary" />,
  },
  {
    id: 5,
    ...
    icon: <CheckSquare className="font-secondary" />,
  },
  {
    id: 6,
    type: "Canceled Orders",
    bgColor: "bg-secondary",
    count: 300, 
    label: "Canceled / Returned Orders",
    icon: <ShoppingBag className="font-secondary" />,
  },
  {
    id: 7,
    type: "Order Value",
