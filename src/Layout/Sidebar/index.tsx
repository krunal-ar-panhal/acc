...
import { getSettingRequest } from "@/Redux/main/actions/settingActions";
...
const Sidebar = () => {
  ...
  const { settings:settingsData } = useAppSelector((store) => store.rootReducer);
  
  const { setting, error, loading,success } = settingsData;
        ...
        <div className="main-header-left d-none d-lg-block">
          <div className="logo-wrapper">
            <Link href={`/${i18LangStatus}/dashboard`}>
              {/* <img className="blur-up lazyloaded" src={settings?.websiteLogo??`${ImagePath}/dashboard/multikart-logo-black.png`} alt="" /> */}
              <img className="blur-up lazyloaded" src={settings?.websiteLogo??`${ImagePath}/dashboard/1.png`} width={100} alt="" />
            </Link>
          </div>
        </div>
